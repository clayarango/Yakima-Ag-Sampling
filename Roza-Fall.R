...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.2155
hist(E1)  
plot(M1)
...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.4208
hist(E1)  
plot(M1)
...
anova(M1) #interpretation, N limitation (presence of Si is lower than absence)
...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.5487
hist(E1)  
plot(M1)
...
anova(M1) #interpretation, no P response (presence of Si and absence of P is depressed)
