...
#P3, O2, T7, K5, L7 could be outliers, controls look OK
...
x
d.gpp$gpp.nrr = d.gpp$gpp.area/3.270044 #divide by control ave_gpp
d.gpp$chla.nrr = d.gpp$chla/0.006951960 #divide by control ave_chla
...
qqline(E1)
ad.test(E1)
   #residuals are not normally distributed, but close p=0.01806
hist(E1)  
plot(M1)
