...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.111
hist(E1)  
plot(M1)
...
anova(M1) #interpretation, N and P limitation (addition of phosphorus synergistic)
...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.2144
hist(E1)  
plot(M1)
...
qqline(E2)
ad.test(E2)
#residuals are not normal, p=0.07118
