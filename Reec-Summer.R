...
qqline(E1)
ad.test(E1)
#residuals are normally distributed p = 0.61
hist(E1)  
plot(M1)

bartlett.test(cr.area~nutrient, data=d.crNoSi)
#variance test 0.046, we'll probably need to mess with this one
...
qqline(E2)
ad.test(E2)
#residuals are normally distributed p = 0.89
hist(E2)  
plot(M2)
...
qqline(E3)
ad.test(E3)
#residuals are not normally distributed p = 0.85
hist(E3)  
plot(M3)
