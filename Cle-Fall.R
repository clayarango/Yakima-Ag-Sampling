...
x
d.cr$cr.nrr = d.cr$cr.area/-7.121497 #is there a prettier way to do this?

#calculate nrr for gpp
x = aggregate(d.gpp[,9], list(d.gpp$nutrient), mean, na.rm=T)
x
d.gpp$gpp.nrr = d.gpp$gpp.area/5.806643 #is there a prettier way to do this?
