...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.1185
hist(E1)  
plot(M1)
...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.3951
hist(E1)  
plot(M1)
...
qqline(E1)
ad.test(E1)
#residuals are normally distributed, p=0.6265
hist(E1)  
plot(M1)
...
anova(M1) #interpretation, P and Si limitation (presence of P really increases Si response)
