...
qqline(E1)
ad.test(E1)
#residuals look good (p=0.45)
hist(E1)
plot(M1)

bartlett.test(cr.area~nutrient, data=d.crNoSi)
#data look good p=0.5241

anova(M1)

#Interpret Interaction
#N and P
xx = na.omit(subset(d.crNoSi, select = c(N,P,cr.area)))
...
qqline(E1)
ad.test(E1)
#residuals look good (p=0.244)
hist(E1)
plot(M1)

bartlett.test(chla~nutrient, data=d.gpp)
#data look bad p=0.0015
